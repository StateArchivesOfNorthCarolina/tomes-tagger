...
# <mets>
mets_el = etree.Element(mets_ns.ns_id + "mets", nsmap=mets_ns.ns_map)

# <metsHdr>
metshdr_el= etree.SubElement(mets_el, mets_ns.ns_id + "metsHdr", nsmap=mets_ns.ns_map)
metshdr_el.append(agentx)

# <dmdSec>
dmdsec_el= etree.SubElement(mets_el, mets_ns.ns_id + "dmdSec", nsmap=mets_ns.ns_map)
dmdsec_el.set("ID", "ID_dmdSec")
dmdsec_el.append(mdwrapx)

# <fileSec>
filesec_el= etree.SubElement(mets_el, mets_ns.ns_id + "fileSec", nsmap=mets_ns.ns_map)
filesec_el.append(filegrpx)

# <structMap>
structmap_el= etree.SubElement(mets_el, mets_ns.ns_id + "structMap", nsmap=mets_ns.ns_map)
